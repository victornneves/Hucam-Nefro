...
def get_speakers(patient_id):
    ...
    gt_file = f"/home/victorneves/Hucam-Nefro/Dataset-Hucam-Nefro/patient_{patient_id}/patient_{patient_id}_transcription_gt.txt"
...
for patient in range(27, 35):
    ...
    with open(f"/home/victorneves/Hucam-Nefro/Dataset-Hucam-Nefro/patient_{patient:03d}/patient_{patient:03d}_transcription_gt.txt", "r") as f:
        ground_truth = f.read()
    with open(f"/home/victorneves/Hucam-Nefro/Dataset-Hucam-Nefro/patient_{patient:03d}/patient_{patient:03d}_transcription_{PASS}_pass.txt", "r") as f:
        prediction = f.read()
