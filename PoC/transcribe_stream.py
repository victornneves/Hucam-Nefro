...
def transcrever_audio_stream(paciente, chunksize=15):
    ...
    try:
        ...
        output_dir = os.path.join(os.path.dirname(__file__), f"transcriptions/{paciente:03d}")
        ...
        for i, chunk in enumerate(chunks):
            ...
            # Saída contínua
            output_path = os.path.join(output_dir, f"{os.path.splitext(os.path.basename(caminho_audio))[0]}_chunk_{i}.txt")
